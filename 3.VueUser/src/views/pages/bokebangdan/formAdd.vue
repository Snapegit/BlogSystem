...
<template>
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"20px","background":"none","width":"1200px","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				<el-col :span="12">
					<el-form-item label="博客分类" prop="bokefenlei">
						<el-select
							class="list_sel"
							:disabled="!isAdd||disabledForm.bokefenlei?true:false"
							v-model="form.bokefenlei" 
							placeholder="请选择博客分类"
							style="width:100%;"
							>
							<el-option v-for="(item,index) in bokefenleiLists" :label="item"
								:value="item"
								>
							</el-option>
						</el-select>
				...
				<el-col :span="12">
					<el-form-item label="博客简介" prop="bokejianjie">
						<el-input v-model="form.bokejianjie" placeholder="博客简介" type="textarea"
						:readonly="!isAdd||disabledForm.bokejianjie?true:false"
						/>
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item label="文章" prop="wenzhang">
						<el-input v-model="form.wenzhang" placeholder="文章" type="textarea"
						:readonly="!isAdd||disabledForm.wenzhang?true:false"
						/>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				if(x=='bokejianjie'){
					form.value.bokejianjie = row[x];
					disabledForm.value.bokejianjie = true;
					continue;
				}
				if(x=='bokefenlei'){
					form.value.bokefenlei = row[x];
					disabledForm.value.bokefenlei = true;
					continue;
				}
				if(x=='wenzhang'){
					form.value.wenzhang = row[x];
					disabledForm.value.wenzhang = true;
					continue;
				}
				if(x=='tupian'){
